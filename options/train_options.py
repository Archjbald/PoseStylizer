...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--optimizer', type=str, default='adam', help='used optimizer')
        ...
        self.parser.add_argument('--L1_type', type=str, default='origin',
                                 choices=['origin', 'l1_plus_perL1', 'FPart_BSSIM_plus_perL1_L1'],
        ...
        self.parser.add_argument('--use_color_loss', action='store_true',
                                 help='color loss instead of perceptual for A')
