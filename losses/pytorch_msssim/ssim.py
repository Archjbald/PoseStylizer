...
class SSIM(torch.nn.Module):
    def __init__(self, win_size=11, win_sigma=1.5, data_range=None, size_average=True, K=(0.01, 0.03),
                 nonnegative_ssim=False):
        r""" class for ssim
        Args:
            win_size: (int, optional): the size of gauss kernel
    ...
    def forward(self, X, Y):
        ...
        return ssim(X_norm, Y_norm, win_size=self.win_size, win_sigma=self.win_sigma, win=self.win,
