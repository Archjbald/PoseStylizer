...
def test(generated_images_dir, annotations_file_test):
    ...
    print("SSIM score = %s masked SSIM = %s" % (structured_score, structured_score_masked,))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--generated_images_dir", default='./results/market_PATN_ssim/test_latest/images',
                        help='Folder with images')
    parser.add_argument("--annotations_file_test", default='./datasets/market_data/market-annotation-test.csv',
