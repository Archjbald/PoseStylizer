...
# PATH test
img_dir = './dataset/test_data/test'  # raw image path
annotations_file = './dataset/test_data/test-annotation-test.csv'  # pose annotation path
save_path = './dataset/test_data/testK'  # path to store pose maps
